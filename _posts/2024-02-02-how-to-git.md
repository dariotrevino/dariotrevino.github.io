...
tags: [Tech]
---
When I was first introduced to Git and GitHub, I was taken aback by the complexity of just trying to do version control. I thought there were too many intricacies needed to just change one thing. Looking back at that time, I wish I would have had a simple guide of everything that Git is comprised of. This is what this post is supposed to be. I hope it helps.


You can use Git on the command line to do version control or clone, fork, pull, and merge repositories. With Git, you can always roll back to a previous version and you can go as far forward or back as you want.

### Using Git in the Terminal
You can use your regular terminal or use the terminal in your IDE to follow these instructions.

### Default Process
1. Open your terminal and navigate to the directory you want to put under version control.
2. git init
	1. This initializes an empty Git repository in your current directory
	2. This will create a .git directory in your current directory (Only visible if you adjust your view or ls -a in the terminal). It will be used to track your changes, commit changes and do version control.
3. git status
...
2. git add .
3. git status
4. git commit -m "complete second and third commit"
...
4. Inside of .gitignore
	...
	3. You can use an * as a wildcard which will ignore all of the files with a certain extension, used as follows: *.txt, *.log.
5. When you git add now, the files in .gitignore will not be added to the staging area.
...
1. git clone url
	...
	3. This allows you to stand on the shoulders of giants and continue where they left off.
...
1. git merge name-of-branch
	...
	2. To close out Vim type :wq to save and quit.
	3. The previous branch will still exist.
2. git push origin main -u

### Forking and Pull Requests
Forking: Copy others' repositories. You can then clone the repository to work on it locally.
